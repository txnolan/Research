...
new G4PVPlacement(0,                // no rotation
   ...
   // Shape 2 (Rectangle)
 G4Material* shape2_mat = nist->FindOrBuildMaterial("GAGG");
 G4ThreeVector pos2 = G4ThreeVector(5.15 * cm, 0, 0);

 // Box shape (rectangular)
 G4double box_halfx2 = 1.4 * cm; // Half-length in x
 G4double box_halfy2 = 1.4 * cm; // Half-length in y
 G4double box_halfz2 = 0.70 * cm; // Half-length in z
